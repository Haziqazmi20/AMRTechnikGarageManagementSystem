...
<a href="registermechanic.php"><button>Add Mechanic</button></a>
<br><table>
        <tr>
            <th>ID</th>
            <th>Name</th>
    ...
    ?>
        <tr>
            ...
            <td><a href="updatemechform.php?id=<?php echo $row["id"]; ?>"><button>Update</button></a>
            <a href="deletemechform.php?matric=<?php echo $row["id"]; ?>"><button>Delete</button></a></td>
        </tr>
